...
class DomerauLvenshtein
{
    ...
    static void Main()
    {
        while (true)
        {
            Console.WriteLine("Введите первое слово (или 'exit' для выхода):");
            string string_one = Console.ReadLine();
            ...
            string string_two = Console.ReadLine();

            WriteDistance(string_one, string_two);
            Console.WriteLine();
        }
    }
}
